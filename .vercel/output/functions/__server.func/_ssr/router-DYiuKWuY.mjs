...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DYiuKWuY.js
var router_DYiuKWuY_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Bn5ZAHBw.css";
var APP_NAME = "MCP OAuth Connect";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Paste the MCP URL you put in Claude, Cursor, Desktop, or Grok. See why Connectors fail when curl works."
			},
			{
				name: "theme-color",
				content: "#f6f7f5"
...
var $$splitComponentImporter = () => import("./routes-CJzykeIb.mjs");
...
//#endregion
export { getRouter, router_DYiuKWuY_exports as t };
