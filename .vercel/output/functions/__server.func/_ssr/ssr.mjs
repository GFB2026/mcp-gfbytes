...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DY9WFjoE.mjs");
...
var manifest = { "e106d9075d3838b3113857169377541a2e3e57e2ffc3caf840a7f82dc4bec37a": {
	functionName: "diagnoseUrl_createServerFn_handler",
	importer: () => import("./diagnose.functions-BRgEpf4q.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DYiuKWuY.mjs").then((n) => n.t),
